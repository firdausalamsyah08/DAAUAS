...
class HealthRecordPolicy
{
    ...
    {
        return $user->can('view_any_health::record');
    }
    ...
    {
        return $user->can('view_health::record');
    }
    ...
    {
        return $user->can('create_health::record');
    }
    ...
    {
        return $user->can('update_health::record');
    }
    ...
    {
        return $user->can('delete_health::record');
    }
    ...
    {
        return $user->can('delete_any_health::record');
    }
     ...
     */
    public function replicate(User $user, HealthRecord $healthRecord): bool
    {
